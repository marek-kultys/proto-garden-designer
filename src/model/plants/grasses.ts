...
export const GRASSES: Species[] = [
  ...
  },
  {
    ...
    hardiness: 'H6',
    sizeClass: 'large',
    flowerColour: 'silvery-white plumes in late summer',
    foliageColour: 'arching blue-green, sharply toothed',
    notes:
      'The full-size pampas: a dense evergreen fountain of blue-green leaves with silvery-white plumes rising to two and a half or three metres in late summer and standing through the winter. Back in fashion, and big — it needs space, and the leaf edges cut like paper, so keep it away from paths. Its seedlings can be invasive, and it now seeds itself along parts of the south-west coast, so choose its place with care. Cut the old growth out in early spring, wearing gloves.',
    source: 'https://www.rhs.org.uk/plants/4431/cortaderia-selloana/details',
  },
  {
    id: 'briza-media',
    ...
    hardiness: 'H7',
    sizeClass: 'small',
    flowerColour: 'dangling heart-shaped lockets, purple-green to straw',
  ...
  },
  {
    ...
    common: "Pampas grass 'Tiny Pampa'",
    latin: "Cortaderia selloana 'Tiny Pampa'",
    genus: 'Cortaderia',
    family: 'Poaceae',
    type: 'grass',
    habit: 'tussock',
    foliage: 'evergreen',
    standing: { from: 285, to: 75 },
    plantedHeight: 0.2,
    plantedSpread: 0.25,
    matureHeight: 0.6,
    matureSpread: 0.6,
    ...
    hardiness: 'H5',
    sizeClass: 'small',
    flowerColour: 'fluffy cream plumes in late summer',

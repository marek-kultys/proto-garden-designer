...
export const PERENNIALS: Species[] = [
  ...
  },
  {
    ...
    hardiness: 'H5',
    sizeClass: 'small',
    flowerColour: 'crimson-pink domes, May to September',
  ...
  {
    id: 'phlomis-amazone',
    common: 'Sage-leaf mullein',
    latin: "Phlomis tuberosa 'Amazone'",
    genus: 'Phlomis',
    family: 'Lamiaceae',
    type: 'perennial',
    habit: 'spire',
    ...
    hardiness: 'H5',
    sizeClass: 'medium',
    flowerColour: 'lilac-pink hooded flowers in tiered whorls',
    foliageColour: 'large, coarse, deep green',
    notes:
      'Tall dark purple stems carrying the flowers in separate tiers up the stem, like a candelabrum, in lilac-pink through June and July. The tiers dry to brown whorls that stand right through the winter and look better still under frost, so leave it uncut until spring. More upright and more colourful than the yellow Phlomis russeliana, and a good partner for grasses. Wants sun and well-drained ground; heavy wet soil rots the tubers. The RHS now calls it Phlomoides tuberosa.',
    source: 'https://www.rhs.org.uk/plants/72387/phlomis-tuberosa-amazone/details',
  },
  {
    ...
    hardiness: 'H7',
    sizeClass: 'medium',
    flowerColour: 'indigo-blue, lupin-like spikes',
  ...
  },
  {
    ...
    latin: "Achillea 'Terracotta'",
    genus: 'Achillea',
    family: 'Asteraceae',
    type: 'perennial',
    habit: 'clump',
    foliage: 'herbaceous',
    standing: { from: 258, to: 60 },
    plantedHeight: 0.2,
    plantedSpread: 0.2,
    matureHeight: 0.8,
    matureSpread: 0.6,
    ...
    hardiness: 'H7',
    sizeClass: 'small',
    flowerColour: 'brick-orange, fading through apricot to ochre',
  ...
  },
  {
    ...
    common: 'Edelweiss',
    latin: 'Leontopodium nivale subsp. alpinum',
    genus: 'Leontopodium',
    family: 'Asteraceae',
    type: 'perennial',
    habit: 'clump',
    ...
    hardiness: 'H6',
    sizeClass: 'small',
    flowerColour: 'white-felted stars in early summer',
    foliageColour: 'narrow, woolly grey-green',
    notes:
      'The mountain flower of the Alps rather than a Mediterranean one, included because it wants what a gravel garden gives: sun, sharp grit and nothing standing wet around its neck. Starry heads of white-felted bracts in June and July on 20 cm stems over narrow woolly leaves. Cold does not trouble it; lowland winter wet does, and it is often short-lived in a British garden. Best in a raised gravel bed, a trough or the cracks of a dry stone wall.',
    source: 'https://www.rhs.org.uk/plants/353775/leontopodium-nivale-subsp-alpinum/details',
  },
  {
    id: 'hylotelephium-lidakense',
    common: "Stonecrop 'Lidakense'",
    latin: "Hylotelephium cauticola 'Lidakense'",
    genus: 'Hylotelephium',
    family: 'Crassulaceae',
    type: 'perennial',
    habit: 'clump',
    ...
    hardiness: 'H5',
    sizeClass: 'small',
    flowerColour: 'pinkish-red heads in late summer',
    foliageColour: 'rounded, blue-grey, edged purple',
    notes:
      'A low stonecrop that trails rather than stands: fleshy blue-grey leaves edged with purple on stems that spread over a gravel edge or the lip of a wall, only ten centimetres high. Flat heads of small pinkish-red stars in August and September, when the bees and butterflies find it. Wants sun and sharp drainage, neutral to limy; in rich damp soil it rots. The small cousin of Herbstfreude, for the front of the bed where that one would be too tall.',
    source: 'https://www.rhs.org.uk/plants/357111/hylotelephium-cauticola-lidakense/details',
  },
];
